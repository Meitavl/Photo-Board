...
load_board_button_img = PhotoImage(file='load_board.png')
save_board_button_img = PhotoImage(file='save_board.png')
save_image_button_img = PhotoImage(file='save_image.png')
copy_ap_button_img = PhotoImage(file='copy_appearance.png')
cha_loc_button_img = PhotoImage(file='change_loc.png')
rotate_button_img = PhotoImage(file='rotate.png')
resize_button_img = PhotoImage(file='resize.png')
close_button_img = PhotoImage(file='close.png')
remove_button_img = PhotoImage(file='remove.png')
replace_loc_button_img = PhotoImage(file='replace.png')
frame_edit_button_img = PhotoImage(file='frame_edit.png')
thick_button_img = PhotoImage(file='thickness.png')
color_button_img = PhotoImage(file='color.png')
